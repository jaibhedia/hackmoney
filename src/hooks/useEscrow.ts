...
export function useEscrow() {
    ...
    const { logTransaction, updateTransactionStatus } = useSuiLogs()
    ...
    const approveUsdc = async (amount: number): Promise<string | null> => {
        ...
        try {
            ...
            console.log('[Arc] USDC approval confirmed:', receipt.transactionHash)
            return receipt.transactionHash
        } catch (error) {
            console.error('[Arc] USDC approval failed:', error)
            return null
        }
    }
    ...
    const createBuyOrder = async (
        ...
        try {
            ...
            console.log('[Arc] Buy order created:', orderId)
            return order
        } catch (error) {
    ...
    const createSellOrder = async (
        ...
        try {
            ...
            console.log('[Arc] Creating escrow...')
            ...
            console.log('[Arc] Escrow created:', receipt.transactionHash)
            ...
            await logTransaction({
                ...
                status: 'pending',
                createdAt: order.createdAt,
                arcTxHash: receipt.transactionHash,
            })
    ...
    const confirmPaymentSent = async (orderId: string): Promise<boolean> => {
        ...
        try {
            ...
            console.log('[Arc] Payment sent confirmed:', orderId)
            return true
        } catch (error) {
    ...
    const confirmPaymentReceived = async (orderId: string): Promise<boolean> => {
        ...
        try {
            ...
            // Call releaseEscrow on Arc
            console.log('[Arc] Releasing escrow...')
            const escrowContract = getEscrowContract()
            ...
            console.log('[Arc] Escrow released:', receipt.transactionHash)
            ...
            await updateTransactionStatus(orderId, 'completed', Date.now())
            return true
        } catch (error) {
    ...
    const cancelOrder = async (orderId: string): Promise<boolean> => {
        ...
        try {
            ...
            if (order?.escrowTxHash) {
                ...
                console.log('[Arc] Escrow refunded:', receipt.transactionHash)
            }
    ...
    const raiseDispute = async (orderId: string, reason: string): Promise<boolean> => {
        ...
        try {
            ...
            console.log('[Arc] Dispute raised:', receipt.transactionHash)
            ...
            await updateTransactionStatus(orderId, 'disputed')
            return true
        } catch (error) {
