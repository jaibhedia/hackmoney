            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                        ...
                        >
                            <Link href={feature.href} className="block group h-full">
                                <div className="p-8 hover:bg-white/[0.03] transition-colors h-full flex flex-col items-start bg-transparent">
                                    {/* Icon - Minimalist */}
                                    <feature.icon className="w-6 h-6 text-gray-400 mb-8 group-hover:text-[#22C55E] transition-colors" strokeWidth={1.5} />
                                    ...
                                    <div className="mt-auto text-sm font-medium text-[#22C55E] opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all flex items-center gap-2">
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {[
                            { step: "01", title: "Load Wallet", desc: "Deposit USDC to your Arc wallet" },
                            ...
                            <div key={item.step} className="relative group">
                                ...
                                <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-white/20 to-transparent group-hover:from-[#22C55E] transition-all duration-500" />
                            </div>
                        ))}
                    </div>
                </motion.div>
