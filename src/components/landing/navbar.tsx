    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 md:px-12 max-w-7xl mx-auto backdrop-blur-md bg-[#030304]/80 border-b border-white/5">
            <Link href="/" className="flex items-center gap-3 cursor-pointer group">
                <span className="text-2xl font-bold text-white tracking-tighter hover:text-[#22C55E] transition-colors">uWu</span>
            </Link>
            ...
            <Link
                href={launchHref}
                className="px-6 py-2.5 bg-[#22C55E] text-white text-sm font-semibold rounded-lg hover:bg-[#16A34A] transition-all shadow-lg shadow-green-500/20"
            >
                {launchText}
            </Link>
        </nav>
