        ...
        <div className="min-h-screen bg-background text-text-primary flex flex-col max-w-md mx-auto relative transition-colors duration-300">
            ...
            <div className="p-4 flex items-center justify-between border-b border-border">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-lg font-bold text-text-primary tracking-tight">SELL USDC</h1>
            ...
            <div className="flex-1 flex flex-col p-4">
                ...
                <div className="bg-surface border border-border p-6 mb-4 flex flex-col items-center justify-center min-h-[160px]">
                    ...
                    <p className="text-xs text-text-secondary font-mono uppercase tracking-widest mt-4">Enter Amount (USDC)</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                    <div className="bg-surface border border-border p-3">
                        ...
                        <p className="text-sm font-bold font-mono text-text-primary">1 USDC = 89.80 INR</p>
                    </div>
                    <div className="bg-surface border border-border p-3">
                        <p className="text-[10px] text-text-secondary uppercase mb-1">Est. Receive</p>
                        <p className="text-sm font-bold font-mono text-brand">₹ {(Number(amount) * 89.80).toFixed(2)}</p>
                    </div>
                </div>
