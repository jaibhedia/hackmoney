        ...
        <div className="pb-24 pt-6 px-4 max-w-md mx-auto min-h-screen">
            ...
            <div className="flex items-center justify-between mb-8 border-b border-border pb-4 border-dashed">
                ...
                <div className="text-center">
                    <h1 className="text-lg font-bold uppercase text-brand">SELL_INR</h1>
                    <p className="text-[10px] text-text-secondary uppercase">GET USDC FOR YOUR INR</p>
                </div>
            ...
            {step === "amount" && (
                <>
                    <div className="bg-black border border-brand/50 p-4 mb-6 relative overflow-hidden group">
                        ...
                        <div className="flex items-baseline gap-2 mb-4">
                            ...
                            <input
                                ...
                                placeholder="0"
                                className="flex-1 bg-transparent text-4xl font-bold font-mono text-white outline-none placeholder:text-gray-800 min-w-0"
                                autoFocus
                            />
                        </div>
                        {fiatAmount > 0 && (
