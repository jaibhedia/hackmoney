 ...
 * 2. Load wallet with USDC on Arc
 * 3. Ready to transact
 */
...
const STEPS = [
    ...
    },
    {
        id: 2,
        title: "Load USDC",
        description: "Deposit USDC to your Arc wallet",
        icon: Coins
    },
    {
        id: 3,
...
export default function OnboardingPage() {
    ...
    const { isConnected, address, balance, isLoading, displayName, markOnboardingComplete, isFirstTimeUser } = useWallet()
    ...
    useEffect(() => {
        if (isConnected && balance > 0 && currentStep === 2) {
            // User already has USDC, can skip to step 3
        }
    }, [isConnected, balance, currentStep])
    ...
    const handleDeposit = async () => {
        ...
        // User needs to send USDC to their wallet address
