            ...
            <div className="max-w-2xl mx-auto px-6 py-10 space-y-10">
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-8">
                    ...
                    <a
                        ...
                        className="flex items-center justify-between p-4 bg-white/[0.03] border border-white/10 rounded-xl hover:border-[#22C55E]/30 hover:bg-[#22C55E]/5 transition-all group"
                    >
                        <div>
                            <p className="text-sm font-medium text-zinc-300 group-hover:text-white transition-colors">Email</p>
                            <p className="text-[#22C55E] font-mono text-sm mt-0.5">info@abstractstudio.in</p>
                        </div>
                        <Mail className="w-4 h-4 text-zinc-600 group-hover:text-[#22C55E] transition-colors" />
                    </a>
