...
async function main() {
    console.log("Deploying uWu P2P V3 Contract (Arc USDC Precompile Compatible)...\n");
    ...
    // ============================================
    console.log("\n" + "=".repeat(50));
    console.log("DEPLOYMENT SUMMARY (Arc USDC Precompile Compatible)");
    ...
    console.log("\n✅ V3 uses raw IERC20 calls (no SafeERC20) for Arc compatibility");
